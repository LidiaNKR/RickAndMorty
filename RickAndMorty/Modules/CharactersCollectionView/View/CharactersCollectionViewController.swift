...
class CharactersCollectionViewController: UICollectionViewController {
    ...
    private var viewModel: CollectionViewViewModelType? = CharacterCollectionViewModel()
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let navigationController = navigationController {
            var characterDetailView = CharacterDetailView(navigationController: navigationController)
            characterDetailView.viewModel = viewModel.viewModelForSelectedRow()
            let hostingView = UIHostingController(rootView: characterDetailView)
